...
public class VistaUsuarios extends JFrame {
	...
	public JPanel getJPanelDetalle() {
		if (jPanelDetalle == null) {
			...
			jLabelCIF = new JLabel();
			jLabelCIF.setText("CIF : ");
			jLabelCIF.setVerticalTextPosition(SwingConstants.TOP);
			jLabelCIF.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabelCIF.setHorizontalTextPosition(SwingConstants.RIGHT);
			jLabelCIF.setVerticalAlignment(SwingConstants.TOP);
			...
			jPanelDetalle.add(jLabelCIF, gridBagConstraints2);
			...
			jPanelDetalle.add(jLabelFax, gridBagConstraints6);
